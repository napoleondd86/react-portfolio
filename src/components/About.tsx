  ...
  return (
    <section id="about" className='border-2 border-orange-600 m-2 p-4  items-center flex flex-col'>
      ...
      <div className='my-8'>
        ...
        <div className='techstack mt-8 flex flex-wrap justify-between'>
          <div className='mt-6 md:mx-4 mx-2 p-4 bg-gray-100 rounded-xl flex items-center md:w-48 w-40'>
