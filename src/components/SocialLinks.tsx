...
const SocialLinks = React.forwardRef<HTMLDivElement, SocialLinksProps>(({className}, ref: ForwardedRef<HTMLDivElement>) => {

  const combinedClassName = `socialLinks_container flex  items-center justify-center flex-wrap ${className}`;
  return (
    <div ref={ref} className={combinedClassName}>
      <Link href="https://github.com" target="_blank" rel="noopener noreferrer" className="social-link flex flex-col items-center justify-center h-12 w-12 group mx-4 rounded-xl hover:shadow-xl text-center">
