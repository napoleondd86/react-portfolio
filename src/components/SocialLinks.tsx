...
const SocialLinks = () => {
  return (
    <div className="socialLinks_container flex  items-center justify-center flex-wrap">
      <Link href="https://github.com" target="_blank" rel="noopener noreferrer" className="social-link flex flex-col items-center justify-center h-16 w-16 sm:w-20 sm:h-20  group mx-4 text-center rounded-full">
        <div className="relative w-16 h-16 sm:w-20 sm:h-20 ">
          ...
          <div className="sawblade-logo absolute inset-0 transition-opacity opacity-0 group-hover:opacity-100">
            <Sawblade className="bg-color-green" />
          </div>
      ...
      <Link href="https://www.linkedin.com/in/kurt-wensmann/" target="_blank" rel="noopener noreferrer" className="social-link flex mx-4 items-center justify-center rounded-3xl  hover:shadow-3xl h-16 w-16 sm:w-20 sm:h-20 group ">
      ...
      <Link href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="social-link flex  items-center justify-center rounded-3xl hover:shadow-3xl h-16 w-16 sm:w-20 sm:h-20 group mx-4">
      ...
      <Link href="mailto:kurtwensmann@gmail.com" className="social-link flex  items-center justify-center rounded-3xl hover:shadow-3xl h-16 w-16 sm:w-20 sm:h-20 group mx-4">
