...
const SocialLinks = () => {
  return (
    <div className="socialLinks_container flex flex-row items-center justify-center flex-wrap">
      ...
      <Link href="/resume.pdf" className="social-link flex  items-center justify-center rounded-3xl hover:shadow-3xl h-16 w-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 group mx-3">
